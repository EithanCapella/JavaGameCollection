...
public class HeMan extends BaseEntity {
    ...
    public HeMan(int x, int y, int width, int height, Handler handler, int col) {
        super(x, y, width, height, Images.galagaHeMan[0], handler);
        this.col = col;
        formationX=(handler.getWidth()/4)+(col*((handler.getWidth()/2)/8))+8;
        BufferedImage[] idleAnimList= new BufferedImage[2];
        idleAnimList[0] = Images.galagaHeMan[0];
        idleAnimList[1] = Images.galagaHeMan[1];
        ...
        attackAnimList[0] = Images.galagaHeMan[0];
        attackAnimList[1] = Images.galagaHeMan[1];
        attackAnimList[2] = Images.galagaHeMan[2];
        attackAnimList[3] = Images.galagaHeMan[3];
        attackAnimList[4] = Images.galagaHeMan[4];
        attackAnimList[5] = Images.galagaHeMan[3];
        attackAnimList[6] = Images.galagaHeMan[2];
        attackAnimList[7] = Images.galagaHeMan[1];
